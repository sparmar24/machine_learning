...
def main():    
    ...
    print("Logistic Regression acc_score = ", ac)
    ...
    print("Kernel SVM acc_score = ", ac_rbf)
    ...
    print("Naive Bayes acc_score = ", ac_b)
    ...
    print("Decision Tree acc_score = ", ac_d)
    ...
    print("Random Forest acc_score = ", ac_rf)
    print("==============================================")
